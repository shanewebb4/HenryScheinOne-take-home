...
public class WordWrapperTest {
    ...
    private final String oneWordToBeWrapped = "a";
    private final String oneWordExpected = "a\n";
    ...
    @Test
    public void shouldReturnOneLetterWord() {
        String actual = WordWrapper.wrap(oneWordToBeWrapped, 12);
